    ...
    <div>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-20 pb-14 text-center">
        ...
        <p className="mt-6 text-[17px] text-[var(--fo-slate)] leading-relaxed">
          Introduced in 2025 by CMS Advanced Primary Care Management improves patient outcomes and 
          delivers up to $280,000 in extra revenue per year for every 1,000 patients to practices. 
          But APCM pays monthly only if all  thirteen service elements are delivered and documented 
          for every enrolled patient. The challenge is effort and throughput. Our AI Agent handles both.
        </p>
